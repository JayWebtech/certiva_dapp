      ...
      <div className="mx-auto px-4 sm:px-10 md:px-8 lg:px-16">
        <div className="flex items-center justify-center mt-[5em]">
          <div className="hero-content text-center py-[64px]">
            <h1 className="text-[2.5em] lg:text-[4em] text-center leading-none lg:leading-15 font-bold">
              {" "}
              Revolutionizing<br></br>{" "}
              <span className="text-primary">Academic Credentials</span> <br />{" "}
              with Blockchain Technology.{" "}
            </h1>
            <p className="my-5 max-w-2xl mx-auto text-center text-sm lg:text-xl">
              {" "}
